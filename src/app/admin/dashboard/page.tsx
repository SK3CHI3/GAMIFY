      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <div className="fixed bottom-4 left-4 right-4 z-50">
          <div className="container mx-auto max-w-4xl">
            <TabsList className="w-full bg-white border border-gray-200 shadow-2xl rounded-2xl p-2 grid grid-cols-4 h-16">
              <TabsTrigger 
                value="overview" 
                className="rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-500 data-[state=active]:to-teal-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all h-12"
              >
