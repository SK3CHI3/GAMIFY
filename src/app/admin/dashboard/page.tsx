      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <div className="fixed bottom-4 left-4 right-4 z-50">
          <div className="container mx-auto max-w-4xl">
            <TabsList className="w-full bg-white/80 backdrop-blur-md border border-blue-200/50 shadow-2xl rounded-2xl p-2 grid grid-cols-4 h-16">
              <TabsTrigger 
                value="overview" 
                className="rounded-xl data-[state=active]:bg-blue-500 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all h-12"
              >
