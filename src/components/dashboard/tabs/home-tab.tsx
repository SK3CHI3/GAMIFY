      ...
      <div className="container mx-auto px-4 py-6 space-y-6 max-w-7xl">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-lg">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {tournaments && tournaments.length > 0 ? (
            ...
            <div className="col-span-2 bg-white border border-gray-200 rounded-2xl p-8 text-center shadow-lg">
